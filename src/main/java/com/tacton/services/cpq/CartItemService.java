...
public class CartItemService {
	...
	private static String CART_ITEM_URI = "/shoppingcartitem";

	private static final String EXCLUDE_ATTRIBUTES = 
			"excludeAttribute=bom" +
			"&excludeAttribute=required-parameters" +
			"&excludeAttribute=integration-attributes";

	public String getProductNameFromCPQApi(String cartItemId) {
		...
		final String url = cpq_api_url + CART_ITEM_URI + "/" + cartItemId + "?" + EXCLUDE_ATTRIBUTES;
